...
Original file is located at
    https://colab.research.google.com/drive/1vfvB1UYqDGryM355x-JzmYDUxaYB-wI6
...
df = pd.read_csv("https://raw.githubusercontent.com/gopiashokan/Industrial-Copper-Modeling/main/data/Copper_Set_Result.csv")
df
...
import joblib
joblib.dump(model,'classification_models.joblib')
...
with open('/content/classification_models.joblib', 'rb') as f:
    model = joblib.load(f)
...
with open('/content/regression_model.joblib', 'rb') as f:
    model = joblib.load(f)
